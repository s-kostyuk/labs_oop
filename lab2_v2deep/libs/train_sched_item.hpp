...
// Сейчас форвардное объявление не подходит:
// GetArriveStation вернет класс-пустышку вместо реального маршрута.
// Результат: нельзя использовать результат GetStation напрямую
//class Station;
